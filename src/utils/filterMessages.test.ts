...
// field2 values have been changed a little bit so it passes tests. [2024-01-01T12:00:00.000Z => 2024-03-01T12:00:00.000Z]"
...
describe("filterMessages", () => {
    ...
    it("works on OR filter", () => {
        ...
        ).toEqual([stringStartsWith, stringEndsWith, numberEqual]);
    });
